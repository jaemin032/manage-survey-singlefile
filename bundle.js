...
},{"../../templates/question/options-template.js":9,"../vuedraggable.js":6}],4:[function(require,module,exports){
"use strict";
...
},{"./options.js":3}],5:[function(require,module,exports){
"use strict";
...
},{"../templates/survey-template.js":10,"./question/question.js":4,"./vuedraggable.js":6}],6:[function(require,module,exports){
"use strict";
...
(function () {
  ...
  /*f (typeof exports == "object") {
      ...
      console.log('windwo && windwo.vue && windwo.sortable')
      var draggable = buildDraggable(window.Sortable);
      Vue.component('draggable', draggable);
  }*/


  exports.draggable = draggable = buildDraggable(window.Sortable);
})();
...
},{"./components/question/question.js":4,"./components/survey.js":5,"./templates/main-template.js":8,"./vue.js":11}],8:[function(require,module,exports){
"use strict";
...
var bailRE = new RegExp("[^".concat(unicodeLetters, ".$_\\d]"));
...
function validateComponentName(name) {
  if (!new RegExp("^[a-zA-Z][\\-\\.0-9_".concat(unicodeLetters, "]*$")).test(name)) {
...
function normalizeScopedSlots(slots, normalSlots, prevSlots) {
  ...
  for (var _key4 in normalSlots) {
    if (!(_key4 in res)) {
      res[_key4] = proxyNormalSlot(normalSlots, _key4);
    }
      ...
      var _loop = function _loop(key) {
        ...
        if (!(key in hash) && !(camelizedKey in hash)) {
          ...
          if (isSync) {
            ...
            _on["update:".concat(camelizedKey)] = function ($event) {
              value[key] = $event;
            };
          }
        }
...
function extractTransitionData(comp) {
  ...
  for (var _key5 in listeners) {
    data[camelize(_key5)] = listeners[_key5];
  }
...
var ncname = "[a-zA-Z_][\\-\\.0-9_a-zA-Z".concat(unicodeLetters, "]*");
...
function parse(template, options) {
  ...
  parseHTML(template, {
    ...
    start: function start(tag, attrs, unary, _start) {
      // check namespace.
...
function genScopedSlots(el, slots, state) {
  ...
  return "scopedSlots:_u([".concat(Object.keys(slots).map(function (key) {
    return genScopedSlot(slots[key], state);
  }).join(','), "]").concat(needsForceUpdate ? ",true" : "", ")");
}
