...
!function (t) {
  ...
  var U,
    ...
    return t === o;
      ...
      gt = function gt(t, e, o) {
    for (var n = t.parentNode; n && !n[lt];) {
      n = n.parentNode;
    }
  ...
  var vt,
      t = function t(_t2) {
    if (_t2 = _t2.touches ? _t2.touches[0] : _t2, U) {
      var e = function (t, e) {
  ...
  return wt(st, "dragover", t), wt(st, "mousemove", t), wt(st, "touchmove", t), mt.prototype = {
    constructor: mt,
    _computeIsAligned: function _computeIsAligned(t) {
      var e;
      ...
      if (f && !C ? (z(), e = st.elementFromPoint(t.clientX, t.clientY), j()) : e = t.target, e = bt(e, this.options.draggable, this.el, !1), !E && U && U.parentNode === this.el) {
        for (var o, n, i, r, a, l, s, c, d = this.el.children, h = 0; h < d.length; h++) {
          bt(d[h], this.options.draggable, this.el, !1) && d[h] !== e && (d[h].sortableMouseAligned = (o = t.clientX, n = t.clientY, i = d[h], r = this._getDirection(t, null), this.options, void 0, a = Lt(i), l = "vertical" === r ? a.left : a.top, s = "vertical" === r ? a.right : a.bottom, l < (c = "vertical" === r ? o : n) && c < s));
        }
    ...
    _prepareDragStart: function _prepareDragStart(t, e, o, n) {
      var i,
          r = this,
          a = r.el,
          l = r.options,
      ...
      o && !U && o.parentNode === a && (q = a, V = (U = o).parentNode, G = U.nextSibling, h = o, Z = l.group, K = n, p = {
        ...
        clientX: (e || t).clientX,
        clientY: (e || t).clientY
      }, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, U.style["will-change"] = "all", U.style.transition = "", U.style.transform = "", i = function i() {
    ...
    _onTouchMove: function _onTouchMove(t, e) {
      if (p) {
        var o = this.options,
    ...
    _appendGhost: function _appendGhost() {
      if (!f) {
        ...
        if (S) {
          for (g = t; "static" === Dt(g, "position") && "none" === Dt(g, "transform") && g !== st;) {
            g = g.parentNode;
          }
            ...
            if (r && r !== U && r.parentNode === i) {
              ...
              if ($ !== r && (et = null, p = Lt(r)[b], rt = !1), C = r, E = u, x = (T = U) === U && nt || Lt(T), N = C === U && nt || Lt(C), M = "vertical" === E ? x.left : x.top, P = "vertical" === E ? x.right : x.bottom, X = "vertical" === E ? x.width : x.height, Y = "vertical" === E ? N.left : N.top, A = "vertical" === E ? N.right : N.bottom, k = "vertical" === E ? N.width : N.height, et = (M === Y || P === A || M + X / 2 === Y + k / 2) && v || m || w || a.invertSwap || "insert" === et || "swap" === et ? ("swap" !== et && (at = a.invertSwap || m), g = function (t, e, o, n, i, r, a) {
                var l = Lt(e),
                    ...
                    f = !1;
                if (!r) if (a && ot < c * n) {
                  if (!rt && (1 === tt ? d + c * i / 2 < s : s < h - c * i / 2) && (rt = !0), rt) f = !0;else {
