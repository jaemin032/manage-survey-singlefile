...
!function (t, e) {
  ...
  function f(t, e) {
    ...
    A.config.silent = !0, t._vm = new A({
      ...
      computed: r
    }), A.config.silent = s, t.strict && _(t), n && (t._withCommit(function () {
      n.state = null;
    }), A.nextTick(function () {
      return n.$destroy();
    }));
  ...
  function p(t, e, n, o, r) {
    ...
    var c = o.context = h(t, s);
    o.forEachMutation(function (e, o) {
      var r = s + o;
      m(t, r, e, n);
    }), o.forEachAction(function (e, o) {
      var r = s + o;
      v(t, r, e, c, n);
    }), o.forEachGetter(function (e, o) {
      var r = s + o;
      y(t, r, e, c, n);
    ...
    var n = "" === e,
      ...
      dispatch: n ? t.dispatch : function (n, o, r) {
        var i = w(n, o, r),
            ...
            a = i.options,
            u = i.type;
        return a && a.root || (u = e + u, t._actions[u]) ? t.dispatch(u, s) : void console.error("[vuex] unknown local action type: " + i.type + ", global type: " + u);
      },
      commit: n ? t.commit : function (n, o, r) {
        var i = w(n, o, r),
            ...
            a = i.options,
            u = i.type;
        return a && a.root || (u = e + u, t._mutations[u]) ? void t.commit(u, s, a) : void console.error("[vuex] unknown local mutation type: " + i.type + ", global type: " + u);
      }
    };
    return Object.defineProperty(o, "getters", {
      get: n ? function () {
        return t.getters;
      } : function () {
        return d(t, e);
  ...
  function v(t, e, n, o, r) {
    ...
    i.push(function (e, i) {
      ...
      return a(s) || (s = Promise.resolve(s)), t._devtoolHook ? s.catch(function (e) {
  ...
  function y(t, e, n, o, r) {
    return t._wrappedGetters[e] ? void console.error("[vuex] duplicate getter key: " + e) : void (t._wrappedGetters[e] = function (t) {
      return n(g(t.state, r), o.getters, t.state, t.getters);
    });
  }
  ...
  function b(t) {
    return A ? void console.error("[vuex] already installed. Vue.use(Vuex) should be called only once.") : (A = t, void e(A));
  }
  ...
  var x = "undefined" != typeof window && window.__VUE_DEVTOOLS_GLOBAL_HOOK__,
    ...
    return n(e).forEach(function (e) {
      ...
      o[n] = function () {
        ...
        if (t) {
          var o = this.$store._modulesNamespaceMap[t];
          if (!o) return void r("mapState", t);
          e = o.state, n = o.context.getters;
        }
  ...
  }, Object.defineProperties(j.prototype, C);

  var $ = function $(t) {
    var e = this;
    this.root = new j(t, !1), t.modules && i(t.modules, function (t, n) {
      e.register([n], t, !1);
    });
  };
  ...
  $.prototype.get = function (t) {
    ...
    var r = this.get(t.slice(0, -1)),
        s = new j(e, n);
    r.addChild(t[t.length - 1], s), e.modules && i(e.modules, function (e, r) {
  ...
  var A,
      V = function V(e) {
    var n = this;
    void 0 === e && (e = {}), u(A, "must call Vue.use(Vuex) before creating a store instance."), u("undefined" != typeof Promise, "vuex requires a Promise polyfill in this browser.");
    var o = e.state;
    void 0 === o && (o = {});
    var r = e.plugins;
    void 0 === r && (r = []);
    var i = e.strict;
    void 0 === i && (i = !1), this._committing = !1, this._actions = Object.create(null), this._mutations = Object.create(null), this._wrappedGetters = Object.create(null), this._modules = new $(e), this._modulesNamespaceMap = Object.create(null), this._subscribers = [], this._watcherVM = new A();
    var s = this,
        a = this,
        c = a.dispatch,
        l = a.commit;
    ...
    }, this.strict = i, p(this, o, [], this._modules.root), f(this, o), r.concat(t).forEach(function (t) {
      return t(n);
    });
  },
      G = {
  ...
  }, V.prototype.registerModule = function (t, e) {
  ...
  }, Object.defineProperties(V.prototype, G), "undefined" != typeof window && window.Vue && b(window.Vue);
  var P = {
    Store: V,
    install: b,
    version: "2.1.1",
